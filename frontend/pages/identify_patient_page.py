...
class IdentifyPatientPage(ctk.CTkFrame):
    ...
    def generate_visit(self, patient_id):
        ...
        print("Generating visit for:", patient_id)
        ...
        try:
            ...
            if data["action"] == "PAYMENT_REQUIRED":
                ...
                self.open_payment_page(
                    ...
                    payment_success_callback=self.after_payment_success,
    ...
    def after_payment_success(self, payment):
        ...
        print("========== AFTER PAYMENT ==========")
        print("Inside after_payment_success")

        print("Current Patient:", self.current_patient_id)

        visit = self.generate_visit(self.current_patient_id)

        print("Returned Visit:", visit)
